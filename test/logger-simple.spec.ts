...
import {
    expect,
    logEntryInterceptor, entryCollector, clearEntryCollector
} from "./testlib";
...
describe('logger-simple', () => {
    ...
    it('SimpleTextDestination - no config', () => {
        SimpleTextDestination.use(LogLevel.OFF).setLogInterceptor(logEntryInterceptor);
    ...
    it('SimpleJsonDestination - json-on info', () => {
        SimpleJsonDestination.use(LogLevel.OFF).setLogInterceptor(logEntryInterceptor);
