...
import { isEmpty, safeStringify, printLine } from "./helper";
 ...
 * @returns
 */
export function buildOutputDataForDestination(
...
export class SimpleJsonDestination extends AbstractLogDestination {
  ...
  protected formatOutput(
    ...
    const data = buildOutputDataForDestination(
      entry.loggables,
      entry.data,
      defaultPayload,
      entry.values,
...
export class SimpleTextDestination extends AbstractLogDestination {
  ...
  protected formatOutput(
    ...
    const merged = buildOutputDataForDestination(
      entry.loggables,
      entry.data,
      defaultPayload,
      entry.values,
