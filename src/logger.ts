 ...
 */
export type TLoggerMessageType =
...
export class JLogger {
  ...
  private extractError(
    ...
    rest: TLoggableEntry[],
  ): [Error | undefined, TLoggableParam[]] {
   ...
   * @returns
   */
  private handleLoggerInputParams(
    message: TLoggerMessageType,
    rest: TLoggableEntry[],
  ): [string, Error | undefined, TLoggableParam[]] {
    ...
    return [messageToUse, errorToUse, parmsToUse];
  }
   ...
   * @returns
   */
  private extractData(input: TLoggableParam[]): {
  ...
  protected log(
    ...
    // Handle message as callback
    const [messageToUse, errorToUse, parmsToUse] = this.handleLoggerInputParams(
      message,
      rest,
    );
